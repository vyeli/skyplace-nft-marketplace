...
<div class="h-screen flex flex-col">
    ...
    <div class="flex flex-col items-center pt-12 w-full grow overflow-clip">
        ...
        <div class="relative mt-12 w-5/12 min-w-[300px] md:min-w-[550px]">
            <!-- Background circles -->
            <div class="absolute w-full h-80 z-0">
                <div
            ...
            <div
                ...
                <div
                    ...
                    <a href="<c:url value="/category/all" />" class="w-full h-full cursor-pointer flex justify-center items-center flex-col">
                        <img src="<c:url value='/resources/all_icon.svg' />" alt="all_icon" />
                ...
                <div
                    ...
                    <a href="<c:url value="/category/collections" />" class="w-full h-full flex justify-center items-center flex-col">
                        <img src="<c:url value='/resources/categories_icon.svg' />" alt="categories_icon" />
                ...
                <div
                    ...
                    <img src="<c:url value='/resources/art_icon.svg' />" alt="art_icon" />
                ...
                <div
                    ...
                    <img src="<c:url value='/resources/utility_icon.svg' />" alt="utility_icon" />
                ...
                <div
                    ...
                    <img src="<c:url value='/resources/photography_icon.svg' />" alt="photography_icon" />
                ...
                <div
                    ...
                    <img src="<c:url value='/resources/other_icon.svg' />" alt="other_icon" />
